...
War.prototype.vikingAttack = function(){
  this.randomNumSaxon = Math.floor(Math.random()*this.saxonArmy.length);
  this.saxon = this.saxonArmy[this.randomNumSaxon];
  this.randomNumViking = Math.floor(Math.random()*this.vikingArmy.length);
...
War.prototype.saxonAttack = function(){
  ...
  if(this.viking.health <= 0){
    this.vikingArmy.splice(this.randomNumViking,1);
  }
